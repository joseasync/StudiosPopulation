...
//        tabBar.tabBar.tintColor = .systemGreen
        ...
        tabBar.viewControllers = [createSearchNationNavigationController(), createSearchStateNavigationController()]
        return tabBar
    }
    ...
    func createSearchNationNavigationController() -> UINavigationController {
        ...
        nationVC.tabBarItem = UITabBarItem(title: "Nation", image: image, tag: 0)
        return UINavigationController(rootViewController: nationVC)
    ...
    func createSearchStateNavigationController() -> UINavigationController {
        ...
        return UINavigationController(rootViewController: stateVC)
    }
